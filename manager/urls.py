...
urlpatterns = [
    ...
    url(r'^accept-invitation/(?P<inv_id>[0-9]+)/$',
        views.acceptInvitation, name='acceptInvitation'),
    url(r'^cancel-invitation/(?P<inv_id>[0-9]+)/$',
        views.cancelInvitation, name='cancelInvitation'),
