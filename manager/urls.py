...
urlpatterns = [
    ...
    url(r'^browse-filesets/(?P<page_number>[0-9]+)/$', 
        views.browseFileSets, name='browseFileSets'),
    url(r'^browse-files/$',
        views.browseCurveFiles, name='browseCurveFiles'),
    ...
    url(r'^browse-curvesets/(?P<page_number>[0-9]+)/$', 
        views.browseCurveSet, name='browseCurveSets'),
    ...
    url(r'^delete-from-curveset/(?P<curveset_id>[0-9]+)/$',
        views.deleteFromCurveSet, name='deleteFromCurveSet'),
