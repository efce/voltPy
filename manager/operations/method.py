...
class Method(ABC):
    ...
    model = None
    has_next = True
    video = '<iframe width="300" height="200" src="https://www.youtube-nocookie.com/embed/vr0HiIed-8Q?rel=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
