"""
Django settings for voltPy project.
...
WSGI_APPLICATION = 'voltPy.wsgi.application'
...
EMAIL_USE_SSL = config.getboolean('email', 'EMAIL_USE_SSL', fallback=False)
EMAIL_HOST = config.get('email', 'EMAIL_HOST')
EMAIL_PORT = config.get('email', 'EMAIL_PORT')
EMAIL_HOST_USER = config.get('email', 'EMAIL_HOST_USER')
EMAIL_HOST_PASSWORD = config.get('email', 'EMAIL_HOST_PASSWORD')
DEFAULT_FROM_EMAIL = config.get('email', 'EMAIL_FROM', fallback=config.get('email', 'EMAIL_HOST_USER'))
"""
LOGGING = {
    'version': 1,
